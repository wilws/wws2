...
import PortfolioDescription from "../portfolio/PortfolioDescription";
import projects from "../../data/test_data";


const BoxView = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    const _boxes = projects.slice().reverse().map((project) => {
  ...
  return (
    <main className="box-view" ref={mainRef}>
